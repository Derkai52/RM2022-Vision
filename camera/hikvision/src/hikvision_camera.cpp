...
//        if (MV_OK == nRet) {
//            printf("set TriggerSelector OK!\n");
//        } else {
//            printf("MV_CC_Set_TriggerSelector fail! nRet [%x]\n", nRet);
//        }
//
//        //********** 设置相机触发模式 **********/
//        nRet = MV_CC_SetEnumValue(handle, "TriggerMode", 1); // 触发
//        if (MV_OK == nRet) {
...
//
//        //********** 设置相机触发源 **********/
//        nRet = MV_CC_SetEnumValue(handle, "TriggerSource", 0); // 触发
//        if (MV_OK == nRet) {
